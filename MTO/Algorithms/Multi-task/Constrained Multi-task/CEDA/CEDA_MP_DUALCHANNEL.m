classdef CEDA_MP_DUALCHANNEL < Algorithm
% <Multi-task> <Single-objective> <Constrained>
%
% Validation variant for dual-channel transfer in Pop1:
% 1) strictly feasible individuals use a feasible-only mapping channel;
% 2) infeasible individuals use an infeasible-only mapping channel.
%
% The overall CEDA_MP framework is kept unchanged. The only algorithmic
% change is how transfer mapping pools are selected inside Generation1.
